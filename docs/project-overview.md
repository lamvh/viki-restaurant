# Project Overview — Viki

## What Viki is

Viki is a Vietnamese street-food restaurant in Glenfield Mall, Auckland. This project
...
Real backend / order persistence / payments (mock order number `VK-####`), auth & real
loyalty accounts, real photography (placeholders via `ImageSlot`), i18n, alternate
