...
// `soon` items render disabled so the nav never points at a route that 404s.
const NAV: NavItem[] = [
...
export function AdminSidebar({ role }: { role: Role }) {
  ...
  return (
    <aside className="no-print flex w-56 shrink-0 flex-col gap-6 border-r border-line bg-surface px-4 py-6">
      <div>
